...
dataset_input <- paste0("./exp03/", PARAM$exp_input, "/dataset_training.csv.gz")
...
dir.create(paste0("./exp03/", PARAM$experimento, "/"), showWarnings = FALSE)

# Establezco el Working Directory DEL EXPERIMENTO
setwd(paste0("./exp03/", PARAM$experimento, "/"))

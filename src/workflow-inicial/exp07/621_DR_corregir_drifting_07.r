...
PARAM <- list()
PARAM$experimento <- "DR6210_07"

PARAM$exp_input <- "CA6110_07"
...
dataset_input <- paste0("./exp07/", PARAM$exp_input, "/dataset.csv.gz")
dataset <- fread(dataset_input)

# creo la carpeta donde va el experimento
dir.create(paste0("./exp07/", PARAM$experimento, "/"), showWarnings = FALSE)
# Establezco el Working Directory DEL EXPERIMENTO
setwd(paste0("./exp07/", PARAM$experimento, "/"))

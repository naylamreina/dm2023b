...
PARAM <- list()
PARAM$experimento <- "DR6210_09"

PARAM$exp_input <- "CA6110_09"
...
dataset_input <- paste0("./exp09/", PARAM$exp_input, "/dataset.csv.gz")
dataset <- fread(dataset_input)

# creo la carpeta donde va el experimento
dir.create(paste0("./exp09/", PARAM$experimento, "/"), showWarnings = FALSE)
# Establezco el Working Directory DEL EXPERIMENTO
setwd(paste0("./exp09/", PARAM$experimento, "/"))

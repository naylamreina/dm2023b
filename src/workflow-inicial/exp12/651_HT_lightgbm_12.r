...
dataset_input <- paste0("./exp12/", PARAM$exp_input, "/dataset_training.csv.gz")
...
dir.create(paste0("./exp12/", PARAM$experimento, "/"), showWarnings = FALSE)

# Establezco el Working Directory DEL EXPERIMENTO
setwd(paste0("./exp12/", PARAM$experimento, "/"))

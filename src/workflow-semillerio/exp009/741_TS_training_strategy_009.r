...
PARAM  <- list()
PARAM$experimento <- "TS7410_008"

PARAM$exp_input  <- "FE7310_008"
...
PARAM$train$validation   <- c( 202106, 202104, 202102, 202012, 202010 )
PARAM$train$testing      <- c( 202107, 202105, 202103, 202101, 202011 )
...
dataset_input  <- paste0( "./exp008/", PARAM$exp_input, "/dataset.csv.gz" )

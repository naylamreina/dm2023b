...
PARAM  <- list()
PARAM$experimento  <- "HT7510_010"

PARAM$exp_input  <- "TS7410_010"
...
exp_log  <- function( reg, arch=NA, folder="./exp010/", ext=".txt", verbose=TRUE )
{
  archivo  <- arch
...
dataset_input  <- paste0( "./exp010/", PARAM$exp_input, "/dataset_training.csv.gz" )

...
PARAM  <- list()
PARAM$experimento  <- "HT7510_012"

PARAM$exp_input  <- "TS7410_012"
...
exp_log  <- function( reg, arch=NA, folder="./exp012/", ext=".txt", verbose=TRUE )
{
  archivo  <- arch
...
dataset_input  <- paste0( "./exp012/", PARAM$exp_input, "/dataset_training.csv.gz" )

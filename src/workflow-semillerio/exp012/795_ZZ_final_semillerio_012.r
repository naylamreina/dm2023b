...
PARAM  <- list()
PARAM$experimento  <- "ZZ7950_012"
PARAM$exp_input  <- "HT7510_012"
...
dir.create( paste0( PARAM$home, "exp012/", PARAM$experimento, "/"), showWarnings= FALSE )
setwd(paste0( PARAM$home, "exp012/", PARAM$experimento, "/"))   #Establezco el Working Directory DEL EXPERIMENTO
...
arch_log  <- paste0( PARAM$home, "exp012/", PARAM$exp_input, "/BO_log.txt" )
tb_log  <- fread( arch_log )
setorder( tb_log, -ganancia )

#leo el nombre del expermento de la Training Strategy
arch_TS  <- paste0( PARAM$home, "exp012/", PARAM$exp_input, "/TrainingStrategy.txt" )
TS  <- readLines( arch_TS, warn= FALSE )

#leo el dataset donde voy a entrenar el modelo final
arch_dataset  <- paste0( PARAM$home, "exp012/", TS, "/dataset_train_final.csv.gz" )
dataset  <- fread( arch_dataset )

#leo el dataset donde voy a aplicar el modelo final
arch_future  <- paste0( PARAM$home, "exp012/", TS, "/dataset_future.csv.gz" )

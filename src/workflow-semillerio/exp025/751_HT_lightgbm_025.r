...
PARAM  <- list()
PARAM$experimento  <- "HT7510_025"

PARAM$exp_input  <- "TS7410_025"
...
exp_log  <- function( reg, arch=NA, folder="./exp025/", ext=".txt", verbose=TRUE )
{
  archivo  <- arch
...
dataset_input  <- paste0( "./exp025/", PARAM$exp_input, "/dataset_training.csv.gz" )

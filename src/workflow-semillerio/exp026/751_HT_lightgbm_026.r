...
PARAM  <- list()
PARAM$experimento  <- "HT7510_026"

PARAM$exp_input  <- "TS7410_026"
...
exp_log  <- function( reg, arch=NA, folder="./exp026/", ext=".txt", verbose=TRUE )
{
  archivo  <- arch
...
dataset_input  <- paste0( "./exp026/", PARAM$exp_input, "/dataset_training.csv.gz" )

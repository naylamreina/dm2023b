...
PARAM  <- list()
PARAM$experimento  <- "HT7510_027"

PARAM$exp_input  <- "TS7410_027"

PARAM$lgb_crossvalidation_folds  <- 5  #En caso que se haga cross validation, se usa esta cantidad de folds

PARAM$lgb_semilla  <- 323591   #cambiar por su propia semilla
...
exp_log  <- function( reg, arch=NA, folder="./exp027/", ext=".txt", verbose=TRUE )
{
  archivo  <- arch
...
PARAM$final_train  <- c( 202107, 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 202002, 202001, 201912 )

PARAM$train$training     <- c( 202101, 202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906)
...
EstimarGanancia_lightgbmCV  <- function( x )
{
  ...
  if( ganancia_normalizada >  GLOBAL_ganancia )
  {
    ...
    fwrite( tb_importancia,
            file= paste0( "impo_", GLOBAL_iteracionPARAM$future       <- c( 202109 )
PARAM$final_train  <- c( 202107, 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 202002, 202001, 201912 )

PARAM$train$training     <- c( 202101, 202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906)
PARAM$train$validation   <- c( 202106, 202104, 202102 )
PARAM$train$testing      <- c( 202107, 202105, 202103 ), ".txt" ),
            sep= "\t" )
...
dataset_input  <- paste0( "./exp027/", PARAM$exp_input, "/dataset_training.csv.gz" )
...
dir.create( paste0( "./exp027/", PARAM$experimento, "/"), showWarnings = FALSE )
setwd(paste0( "./exp027/", PARAM$experimento, "/"))   #Establezco el Working Directory DEL EXPERIMENTO

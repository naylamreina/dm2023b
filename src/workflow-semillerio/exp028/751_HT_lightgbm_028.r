...
PARAM  <- list()
PARAM$experimento  <- "HT7510_028"

PARAM$exp_input  <- "TS7410_028"
...
exp_log  <- function( reg, arch=NA, folder="./exp028/", ext=".txt", verbose=TRUE )
{
  archivo  <- arch
...
dataset_input  <- paste0( "./exp028/", PARAM$exp_input, "/dataset_training.csv.gz" )
...
dir.create( paste0( "./exp028/", PARAM$experimento, "/"), showWarnings = FALSE )
setwd(paste0( "./exp028/", PARAM$experimento, "/"))   #Establezco el Working Directory DEL EXPERIMENTO

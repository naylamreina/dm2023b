...
PARAM$train$training     <- c( 202105, 202104, 202101, 202012, 202009, 202008, 202007, 202006, 202005, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906 )
PARAM$train$validation   <- c( 202106, 202102, 202010 )
PARAM$train$testing      <- c( 202107, 202103, 202011)
...
dataset_input  <- paste0( "./exp030/", PARAM$exp_input, "/dataset.csv.gz" )
dataset  <- fread( dataset_input )


#creo la carpeta donde va el experimento
dir.create( paste0( "./exp030/", PARAM$experimento, "/"), showWarnings = FALSE )
setwd(paste0( "./exp030/", PARAM$experimento, "/"))   #Establezco el Working Directory DEL EXPERIMENTO

...
PARAM  <- list()
PARAM$experimento  <- "HT7510_030"

PARAM$exp_input  <- "TS7410_030"
...
exp_log  <- function( reg, arch=NA, folder="./exp030/", ext=".txt", verbose=TRUE )
{
  archivo  <- arch
...
dataset_input  <- paste0( "./exp030/", PARAM$exp_input, "/dataset_training.csv.gz" )

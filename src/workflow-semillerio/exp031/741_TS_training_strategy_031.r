...
PARAM  <- list()
PARAM$experimento <- "TS7410_031"

PARAM$exp_input  <- "FE7310_031"

# me salteo los meses duros de pandemia, pero llego hasta 201907 en training
# entreno en 18 meses

PARAM$future       <- c( 202109 )
PARAM$final_train  <- c( 202107, 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 202004, 202002, 202001)

PARAM$train$training     <- c( 202101, 202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 202004, 202002, 202001, 201912, 201911, 201910, 201909, 201908 , 201907)
PARAM$train$validation   <- c( 202104, 202103, 202102 )
...
dataset_input  <- paste0( "./exp031/", PARAM$exp_input, "/dataset.csv.gz" )
dataset  <- fread( dataset_input )


#creo la carpeta donde va el experimento
dir.create( paste0( "./exp031/", PARAM$experimento, "/"), showWarnings = FALSE )
setwd(paste0( "./exp031/", PARAM$experimento, "/"))   #Establezco el Working Directory DEL EXPERIMENTO

...
PARAM  <- list()
PARAM$experimento  <- "HT7510_031"

PARAM$exp_input  <- "TS7410_031"
...
exp_log  <- function( reg, arch=NA, folder="./exp031/", ext=".txt", verbose=TRUE )
{
  archivo  <- arch
...
dataset_input  <- paste0( "./exp031/", PARAM$exp_input, "/dataset_training.csv.gz" )

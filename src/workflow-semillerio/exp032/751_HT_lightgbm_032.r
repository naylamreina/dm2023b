...
PARAM  <- list()
PARAM$experimento  <- "HT7510_032"

PARAM$exp_input  <- "TS7410_032"
...
exp_log  <- function( reg, arch=NA, folder="./exp032/", ext=".txt", verbose=TRUE )
{
  archivo  <- arch
...
dataset_input  <- paste0( "./exp032/", PARAM$exp_input, "/dataset_training.csv.gz" )

...
PARAM  <- list()
PARAM$experimento  <- "HT7510_029"

PARAM$exp_input  <- "TS7410_029"
...
exp_log  <- function( reg, arch=NA, folder="./exp029/", ext=".txt", verbose=TRUE )
{
  archivo  <- arch
...
dataset_input  <- paste0( "./exp029/", PARAM$exp_input, "/dataset_training.csv.gz" )

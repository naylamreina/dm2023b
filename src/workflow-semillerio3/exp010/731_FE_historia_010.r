...
PARAM  <- list()
PARAM$experimento <- "FE7310_010"

PARAM$exp_input  <- "DR7210_010"
...
dataset_input  <- paste0( "./exp010/", PARAM$exp_input, "/dataset.csv.gz" )
...
dir.create( paste0( "./exp010/", PARAM$experimento, "/"), showWarnings = FALSE )
setwd(paste0( "./exp010/", PARAM$experimento, "/"))   #Establezco el Working Directory DEL EXPERIMENTO
